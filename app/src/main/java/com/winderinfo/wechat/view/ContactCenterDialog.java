 ...
 * 2019/11/25
 */
public class ContactCenterDialog extends DialogFragment {
    TextView tvCancel;
    TextView tvCommit;
    EditText etInput;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_edit_friend_lay, null);
        ...
        tvCommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(toString)) {
                    Toast.makeText(getContext(), "请输入好友数量", Toast.LENGTH_SHORT).show();
                    return;
                }
